...
const calculateBuyValue = function(ask, tradeValue,  precision = undefined) {
    ...
    // log('amount to be bought: '.yellow, tradeValue)
...
let getBTCPairs = function() {            let pairs = ['AAVE',
// 'ADA',
// 'AION',
// 'ALGO',
// 'ALPHA',
...
;(async () => {
    ...
    try {
            let pairs = getBNBPairs()

            let primaryMarket = "USDT"
            let intermediaryMarket = "BNB"
